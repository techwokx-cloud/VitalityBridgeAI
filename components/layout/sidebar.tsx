...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden w-64 border-r border-[#ebe5ef] bg-white md:block">
      {/* LOGO */}
      <div className="flex items-center gap-3 border-b border-[#ebe5ef] px-6 py-6">
        ...
        <div>
          <div className="font-serif text-lg font-semibold text-[#191735]">
            Vitality<span className="text-[#6845d8]">Bridge</span>
          </div>

          <div className="text-[10px] text-[#9a91a3]">Life companion</div>
        </div>
      </div>
      ...
      <div className="border-t border-[#ebe5ef] p-6">
        ...
        <div className="rounded-[20px] border-2 border-[#6845d8] bg-gradient-to-br from-[#f0e9ff] to-[#ede4ff] p-4 text-center">
          ...
          <button className="mt-4 w-full rounded-full bg-[#6845d8] py-2 text-xs font-semibold text-white transition hover:bg-[#5535c4]">
            Start Talking
          </button>
        </div>
